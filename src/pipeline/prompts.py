...
def addition_suggest_offset(client, sampled_instance, class_name, image):
    ...
    2. **Removal**: A part is deleted and the background is inpainted over it (e.g., missing tail, finger, or mirror).
    ...
    - **Humans/Animals**: fingers, hands, toes, ears, tails.
    - **Vehicles**: mirrors, wheels, wipers.
    ...
    5. For **peripheral or terminal parts** (e.g., tail, ear), placing the duplicate near the **edge of the entity** is often most effective.
