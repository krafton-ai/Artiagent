...
def read_tfrecord_file(file_path, save_root='richhf-18k', split='train', tag=None):
    ...
    for raw_record in tqdm(raw_dataset):
        ...
        for key, value in example.features.feature.items():
            if value.bytes_list.value:
                if key == 'filename':
                    ...
                    with open(os.path.join(save_path, f'{key}.png'), 'wb') as f:
        ...
        with open(os.path.join(save_path, f'{uid}.png'), 'wb') as f:
...
pickapic = load_dataset("pickapic-anonymous/pickapic_v1", num_proc=64, cache_dir='./data')
print("Loaded pickapic dataset")

train_file_path = "/home/jovyan/image-artifacts/data/richhf-18k/train.tfrecord"
train_uids = get_uids(train_file_path)
test_file_path = "/home/jovyan/image-artifacts/data/richhf-18k/test.tfrecord"
test_uids = get_uids(test_file_path)
dev_file_path = "/home/jovyan/image-artifacts/data/richhf-18k/dev.tfrecord"
...
full_dataset.save_to_disk('/home/jovayn/image-artifacts/data/richhf-18k/rich_human_feedback_dataset')