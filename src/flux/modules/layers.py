...
from flux.math import attention, attention_manipulated, attention_masked, attention_manipulated_masked, rope, get_attn_mask
...
class SingleStreamBlock(nn.Module):
    ...
    def forward(self, x: Tensor, vec: Tensor, pe: Tensor, info, patch_ids) -> Tensor:
        ...
        if info['inject'] and info['id'] > 19 and info['id'] < 35:
